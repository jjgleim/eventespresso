...
function espresso_process_paypal($payment_data) {
	...
	if ($myPaypal->validateIpn()) {
		...
		if ($myPaypal->ipnData['mc_gross'] >= $payment_data['amount_owed'] && ($myPaypal->ipnData['payment_status'] == 'Completed' || $myPaypal->ipnData['payment_status'] == 'Pending')) {
			...
			wp_mail($payment_data['contact'], $subject, $body);*/
			die;
		} elseif ($myPaypal->ipnData['mc_gross'] <= $payment_data['amount_owed'] && $myPaypal->ipnData['payment_status'] == 'Pending') {
