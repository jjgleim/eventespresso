...
<div class="event-data-display ui-widget-content ui-corner-bottom">
	...
	<div class="event-meta">
			<?php 
				if ( $event->event_cost[0] != '0.00' ) { ?>
		<p id="p_event_price-<?php echo $event_id ?>" class="event_price"><span class="section-title"><?php  echo __('Price: ', 'event_espresso'); ?></span> <?php
					foreach ($event->event_cost as $cost) {
			?>
					 <?php echo  $org_options['currency_symbol'].$cost; ?>, <?php
					} ?></p><?php
			} else { ?> 
